...
$repoBase = "https://raw.githubusercontent.com/michaelwebiscope/battledeck/main/newrelic-config"
...
if (-not $SkipDynatraceRemoval) {
    ...
    $destroyerUrl = "$repoBase/dynadog-destroyer.ps1"
...
$instrumentUrl = "$repoBase/instrument-dotnet-services-newrelic.ps1"
